 ...
 * @prop    {Boolean} [options.recursive=false]      Whether subfolders are included
 ...
 * @prop    {Boolean} [options.removeExtension=true] Whether the extensions of file names are removed from the property names
